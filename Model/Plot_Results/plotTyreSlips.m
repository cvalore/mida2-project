...
plot(out.tout', out.logsout.find('BlockPath', 'Model3/slip_angle_F[deg]').getElement(1).Values(:,1).Data, ...
...
plot(out.tout', out.logsout.find('BlockPath', 'Model3/slip_angle_R[deg]').getElement(1).Values(:,1).Data, ...
