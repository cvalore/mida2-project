...
set_param('Model1/Controller/Fx_input_step[N]', 'Commented', 'off');
...
set_param('Model1/Controller/Fx_input_step[N]', 'Before', num2str(force1));
set_param('Model1/Controller/Fx_input_step[N]', 'After', num2str(force2));
set_param('Model1/Controller/Fx_input_step[N]', 'Time', num2str(stepTime));
