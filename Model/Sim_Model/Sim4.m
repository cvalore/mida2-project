...
set_param('Model3/Controller/Fx_input_step[N]', 'Commented', 'off');
...
add_line('Model3/Controller',Fx_input_step.Outport(1),fxInputBlock.Inport(1));
add_line('Model3/Controller',delta_input_const.Outport(1),deltaInputBlock.Inport(1));

set_param('Model3/Controller/Fx_input_step[N]', 'Before', num2str(force1));
set_param('Model3/Controller/Fx_input_step[N]', 'After', num2str(force2));
set_param('Model3/Controller/Fx_input_step[N]', 'Time', num2str(stepTime));
