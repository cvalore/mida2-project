...
set_param('Model1/Controller/delta_input_sin[deg]', 'Commented', 'off');
...
add_line('Model1/Controller',delta_input_sin.Outport(1),deltaInputBlock.Inport(1));

set_param('Model1/Controller/Fx_input_const[N]', 'Value', num2str(force));
set_param('Model1/Controller/delta_input_sin[deg]', 'Amplitude', num2str(steerAmpl));
set_param('Model1/Controller/delta_input_sin[deg]', 'Frequency', num2str(steerFreq));
