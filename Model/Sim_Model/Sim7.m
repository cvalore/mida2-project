...
PID_vel = get_param('Model1/Controller/PID_vel','PortHandles');
...
delta_input_ramp = get_param('Model1/Controller/delta_input_ramp[deg]','PortHandles');
...
set_param('Model1/Controller/Fx_input_const[N]', 'Commented', 'on');
...
set_param('Model1/Controller/delta_input_const[deg]', 'Commented', 'on');
set_param('Model1/Controller/delta_input_ramp[deg]', 'Commented', 'off');
set_param('Model1/Controller/v_ref[ms^-1]', 'Commented', 'off');
set_param('Model1/Controller/error', 'Commented', 'off');
set_param('Model1/Controller/PID_vel', 'Commented', 'off');

add_line('Model1/Controller',PID_vel.Outport(1),fxInputBlock.Inport(1));
add_line('Model1/Controller',delta_input_ramp.Outport(1),deltaInputBlock.Inport(1));

set_param('Model1/Controller/v_ref[ms^-1]', 'Value', num2str(ref_vel));
set_param('Model1/Controller/delta_input_ramp[deg]', 'slope', num2str(slope));
set_param('Model1/Controller/delta_input_ramp[deg]', 'start', num2str(start));
set_param('Model1/Controller/delta_input_ramp[deg]', 'InitialOutput', num2str(initial_output));
...
%% simulate
t_sim = 100;
set_param('Model1','Solver','ode15s','StopTime', int2str(t_sim));
out = sim('Model1', 'ReturnWorkspaceOutputs', 'on');

fxInputBlockLine = get_param('Model1/Controller/Fx','LineHandles');
delete_line(fxInputBlockLine.Inport(1));
add_line('Model1/Controller',Fx_input_const.Outport(1),fxInputBlock.Inport(1));
set_param('Model1/Controller/v_ref[ms^-1]', 'Commented', 'on');
set_param('Model1/Controller/error', 'Commented', 'on');
set_param('Model1/Controller/PID_vel', 'Commented', 'on');
set_param('Model1/Controller/Fx_input_const[N]', 'Commented', 'off');
deltaInputBlockLine = get_param('Model1/Controller/toRad','LineHandles');
delete_line(deltaInputBlockLine.Inport(1));
set_param('Model1/Controller/delta_input_ramp[deg]', 'Commented', 'on');
