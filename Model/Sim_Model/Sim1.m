...
%% set inputs
% Fxinput = get_param('Model1/Controller/Fx_input[N]','PortHandles');
% inputBlock = get_param('Model1/Controller/Fx','PortHandles');
% delete_line('Model1/Controller',Fxinput.Outport(1),inputBlock.Inport(1));
% add_line('Model1/Controller',Fxinput.Outport(1),inputBlock.Inport(1));
%set_param('Model1/Controller/prova', 'Commented', 'on');
bankingON = 0;
slipstreamON = 0;
init_vel = 20;
force = 0;
